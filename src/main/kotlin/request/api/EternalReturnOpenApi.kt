...
sealed class EternalReturnOpenApi(
    ...
    sealed class User(
        ...
        class GetUserStats(userNum: Long, seasonId: Int, matchingMode: MatchingMode) :
            User("/v2/user/stats/${userNum}/${seasonId}/${matchingMode.value}", HttpMethod.Companion.Get)
    ...
    sealed class Game(
        ...
        class GetGamesByUserId(userId: Long) : Game("/v1/user/games/${userId}", HttpMethod.Companion.Get)
